...
export default function Forcast() {
  ...
  var [weatherIcon, setWeatherIcon] = useState("CLEAR_DAY")
    ...
    async function getData() {
      if(city !== ""){
        ...
        if (response.status === 200) {
          ...
          console.log(data);
          if(data.weather[0].main === "Thunderstorm" || data.weather[0].main === "Rain"|| data.weather[0].main === "Drizzle" || data.weather[0].main === "Mist"){
            setWeatherIcon("RAIN");
          }
          ...
          else if(data.weather[0].main === "Smoke" || data.weather[0].main === "Fog" || data.weather[0].main === "Dust"){
            setWeatherIcon("FOG");
          }
          setWeather(data);
        } else {
          ...
          navigator.geolocation.getCurrentPosition(
            async (pos)=>{
              ...
              if (response2.status === 200) {
                ...
                if(data2.weather[0].main === "Thunderstorm" || data2.weather[0].main === "Rain"|| data2.weather[0].main === "Drizzle" || data2.weather[0].main === "Mist"){
                  setWeatherIcon("RAIN");
                }
                ...
                else if(data2.weather[0].main === "Smoke" || data2.weather[0].main === "Fog" || data2.weather[0].main === "Dust"){
                  setWeatherIcon("FOG");
                }
  ...
  return (
    <div className="forcast-container">
      ...
      <div className="right-forecast">
        {error === false ? (
          <> 
            ...
            <div className="search-container">
              <input type="text" placeholder="Search.." id="cityName" />
        ...
        <>
        <div className="search-container srh">
              <input type="text" placeholder="Search.." id="cityName" />
              <button onClick={searchCity}>
                <img src={search} alt="search" width={20} />
              </button>
